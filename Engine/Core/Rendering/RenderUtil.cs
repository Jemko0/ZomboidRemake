...
namespace Iso.Engine.Core.Rendering
{
    public class RenderUtil
    {
        ...
        /// <param name="camera"></param>
        /// <returns></returns>
        public static Vector2 ScreenToWorld(Vector2 screen, float tileWidth, float tileHeight, IsoCamera camera)
        {
        ...
        public static Vector2 ScreenToWorldAtZ(Vector2 screen, float tileWidth, float tileHeight, IsoCamera camera, float targetZ)
        {
            float x = screen.X - window.ClientBounds.Width / 2f;
            float y = screen.Y - window.ClientBounds.Height / 2f;
